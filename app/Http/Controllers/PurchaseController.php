...
class PurchaseController extends Controller
{
    ...
    {
        $pembelian = Purchase::orderBy('id_pembelian', 'desc')->get();
    ...
    {
        $pembelian = Purchase::findOrFail($request->id_pembelian);
        ...
        $detail = PurchaseDetail::where('id_pembelian', $pembelian->id_pembelian)->get();
    ...
    {
        $detail = PurchaseDetail::with('produk')->where('id_pembelian', $id)->get();
